...
namespace CIAT.DAPA.USAID.Forecast.WebAdmin.Controllers
{
    ...
    public class CultivarController : WebAdminBaseController
    {
        ...
        public CultivarController(IOptions<Settings> settings, IHostingEnvironment hostingEnvironment, UserManager<IdentityUser> userManager, SignInManager<IdentityUser> signInManager, RoleManager<IdentityRole> roleManager, IEmailSender emailSender) : 
