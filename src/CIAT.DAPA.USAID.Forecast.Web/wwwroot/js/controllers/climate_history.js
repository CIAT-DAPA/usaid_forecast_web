angular.module('ForecastApp')
  .controller('ClimateHistoryCtrl', function ($scope, config, tools, HistoricalFactory, ClimatologyFactory, HistoricalClimateFactory,
                                    ForecastFactory, ClimateFactory, 
                                    WeatherStationFactory, $rootScope) {
