...
angular
  ...
  .value('config', {
      ...
      expert_db: [
          ...
          { section: 'climate_historical', title: 'Histórico climático', description: 'Usted puede por cada estación climática obtener los datos históricos mensuales que son usados para realizar la predicción climática. Se pueden obtener datos de variables como temperaturas máximas y mínimas, precipitación y radiación solar de cada mes durante un intervalo de tiempo. Usted podrá descargar el valor para radiación solar, temperatura máxima y temperatura mínima para todos los meses desde 1980 al 2014 provenientes de la estación del IDEAM utilizada para generar la información del municipio seleccionado.' },
